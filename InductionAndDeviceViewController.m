...
{
	 [super viewDidLoad];
	 [self.ivBBCheckBox addTarget:self action:@selector(radioGroup1:) forControlEvents:UIControlEventTouchUpInside];
	 [self.imBBCheckBox addTarget:self action:@selector(radioGroup1:) forControlEvents:UIControlEventTouchUpInside];
	 [self.inhalationBBCheckBox addTarget:self action:@selector(radioGroup1:) forControlEvents:UIControlEventTouchUpInside];
	 [self.oralAirwayBBCheckBox addTarget:self action:@selector(radioGroup2:) forControlEvents:UIControlEventTouchUpInside];
	 [self.nasalAirwayBBCheckBox addTarget:self action:@selector(radioGroup2:) forControlEvents:UIControlEventTouchUpInside];
	 [self.maskBBCheckBox addTarget:self action:@selector(radioGroup2:) forControlEvents:UIControlEventTouchUpInside];
	 if (_section) {
...
-(void)radioGroup1:(BBCheckBox*)sender {
	 ...
	 self.ivBBCheckBox.selected = NO;
	 self.imBBCheckBox.selected = NO;
	 self.inhalationBBCheckBox.selected = NO;
	 sender.selected = selected;
}
-(void)radioGroup2:(BBCheckBox*)sender {
	 BOOL selected = sender.selected;
	 self.oralAirwayBBCheckBox.selected = NO;
	 self.nasalAirwayBBCheckBox.selected = NO;
	 self.maskBBCheckBox.selected = NO;
	 sender.selected = selected;
}
@end