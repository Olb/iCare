...
{
	 [super viewDidLoad];
	 [self.oralBBCheckBox addTarget:self action:@selector(radioGroup1:) forControlEvents:UIControlEventTouchUpInside];
	 [self.nasalBBCheckBox addTarget:self action:@selector(radioGroup1:) forControlEvents:UIControlEventTouchUpInside];
	 [self.trachBBCheckBox addTarget:self action:@selector(radioGroup1:) forControlEvents:UIControlEventTouchUpInside];
	 [self.doubleLumenLeftBBCheckBox addTarget:self action:@selector(radioGroup2:) forControlEvents:UIControlEventTouchUpInside];
	 [self.doubleLumenRightBBCheckBox addTarget:self action:@selector(radioGroup2:) forControlEvents:UIControlEventTouchUpInside];
	 if (_section) {
...
-(void)radioGroup1:(BBCheckBox*)sender {
	 ...
	 self.oralBBCheckBox.selected = NO;
	 self.nasalBBCheckBox.selected = NO;
	 self.trachBBCheckBox.selected = NO;
	 sender.selected = selected;
}
-(void)radioGroup2:(BBCheckBox*)sender {
	 BOOL selected = sender.selected;
	 self.doubleLumenLeftBBCheckBox.selected = NO;
	 self.doubleLumenRightBBCheckBox.selected = NO;
	 sender.selected = selected;
}
@end