...
+(CGSize) drawAnesthesiaTypeSection:(FormSection*)section atLocation:(CGPoint)sectionOrigin
{
	 ...
	 group1CursorStart.x += group1Indentation;
	 group1CursorStart.x += 0;
	 ...
	 group2CursorStart.x += group2Indentation;
	 group2CursorStart.x += 0;
	 ...
	 cursor.x += previousElementSize.width + 8;
	 previousElementSize.width = cursor.x - cursorStartX;
	 cursor.x += previousElementSize.width + 8;
	 ...
	 group3CursorStart.x += group3Indentation;
	 group3CursorStart.x += 0;
	 cursorStartX = cursor.x;
	 ...
	 group4CursorStart.x += group4Indentation;
	 group4CursorStart.x += 0;
	 cursorStartX = cursor.x;
	 ...
	 group1CursorStart.x -= group1Indentation;
	 group1CursorStart.x -= 0;
	 previousElementSize = CGSizeMake(group1MaxWidth + 15, cursor.y -group1CursorStart.y + 10);
...
+(CGSize) drawBetaBlockerSection:(FormSection*)section atLocation:(CGPoint)sectionOrigin
{
	 ...
	 group2CursorStart.x -= group2Indentation;
	 group2CursorStart.x -= 10;
	 previousElementSize = CGSizeMake(group2MaxWidth + 0, cursor.y -group2CursorStart.y + 0);
	 cursor = group2CursorStart;
...
+(CGSize) drawDiagnosticStudiesSection:(FormSection*)section atLocation:(CGPoint)sectionOrigin
{
	 ...
	 group5CursorStart.x += group5Indentation;
	 group5CursorStart.x += 0;
	 cursorStartX = cursor.x;
	 ...
	 group6CursorStart.x += group6Indentation;
	 group6CursorStart.x += 0;
	 cursorStartX = cursor.x;
	 ...
	 group7CursorStart.x += group7Indentation;
	 group7CursorStart.x += 0;
	 cursorStartX = cursor.x;
...
+(CGSize) drawEndotrachealTubeSection:(FormSection*)section atLocation:(CGPoint)sectionOrigin
{
	 ...
	 group3CursorStart.x -= group3Indentation;
	 group3CursorStart.x -= 0;
	 previousElementSize = CGSizeMake(group3MaxWidth + 0, cursor.y -group3CursorStart.y + 10);
	 cursor = group3CursorStart;
	 ...
	 group8CursorStart.x += group8Indentation;
	 group8CursorStart.x += 0;
	 cursorStartX = cursor.x;
	 previousElementSize = [BBPdfGenerator drawText:@"Size" atLocation:cursor];
	 cursor.x += previousElementSize.width + 8;
	 ...
	 group6CursorStart.x -= group6Indentation;
	 group6CursorStart.x -= 0;
	 previousElementSize = CGSizeMake(group6MaxWidth + 0, cursor.y -group6CursorStart.y + 10);
	 cursor = group6CursorStart;
...
+(CGSize) drawIVAntibioticNameSection:(FormSection*)section atLocation:(CGPoint)sectionOrigin
{
	 ...
	 group1CursorStart.x -= group1Indentation;
	 group1CursorStart.x -= 0;
	 previousElementSize = CGSizeMake(group1MaxWidth + 0, cursor.y -group1CursorStart.y + 10);
	 cursor = group1CursorStart;
